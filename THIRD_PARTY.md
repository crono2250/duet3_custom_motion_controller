...
| CANlib 3.6.3 | `f0a4c6d53d0cb3ccff8cc4309c2b4b67e158efab` | **明示license file未確認**（[upstream issue #11](https://github.com/Duet3D/CANlib/issues/11)） | 確認完了までsourceを取り込まない |
